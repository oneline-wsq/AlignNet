...
def getAllPoints(idx,gt_file,frame_nums,ego2gs):
    ...
    for f_name in add_frames:
        ...
        # 读对应的json文件
        with open(f"dataset/pred/{f_name}", 'r') as f:
            data = json.load(f)
...
if __name__=='__main__':
    ...
    n=0
    root_path = r"imgs/preds_multiframe"

    gts=sorted(os.listdir('dataset/pred'))
    ...
    for idx, gt_file in enumerate(gts): 
        ...
        json_path=f'dataset/pred_multiframes/{token}.json'
